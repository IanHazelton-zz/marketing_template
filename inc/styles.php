...
function talon_custom_styles($custom) {
	...
	$primary_color_hover			= get_theme_mod('primary_color_hover', $defaults['primary_color_hover']);
	$secondary_color_hover			= get_theme_mod('secondary_color_hover', $defaults['secondary_color_hover']);
  ...
  $custom 	.= ".button { background-color:" . esc_attr($primary_color) . ";}"."\n";
	$custom 	.= ".button:hover { background-color:" . esc_attr($primary_color_hover) . ";}"."\n";
	$custom 	.= ".white-btn.button { background-color:" . esc_attr($secondary_color) . ";}"."\n";
	$custom 	.= ".white-btn.button:hover { background-color:" . esc_attr($secondary_color_hover) . ";}"."\n";
