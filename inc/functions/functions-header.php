	...
	if ( $header_type == 'has-slider' ) {
		...
		echo 	'<div class="main-slider" data-sliderspeed="' . absint($sliderspeed) . '">';
			...
			for ($c = 1; $c <= 3; $c++) {
				...
				$slide_btn_alt_title = get_theme_mod('slide_btn_alt_title_' . $c);
				//To Do - figure out how to give these alt buttons their own text input in the wordpress UI
				...
				if ( !function_exists('pll_register_string') ) {
					...
					$slide_btn_alt_title = pll__(get_theme_mod('slide_btn__alt_title_' . $c));
				}
						...
						<div class="main-slider-caption container">
							<div>
								...
								<div class="header-button">
									...
									<a class="button white-btn" href="<?php echo esc_url($slide_btn_url); ?>"><?php echo esc_html($slide_btn_alt_title); ?></a>
								</div>
								<?php endif; ?>
							</div>
						</div>
