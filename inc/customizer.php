...
function talon_customize_register( $wp_customize ) {
	...
	for ($c = 1; $c <= 3; $c++) {
	    ...
	    $wp_customize->add_control(
	        'slide_btn_alt_title_' . $c,
	        array(
	            'label' 	=> __( ' Alt Button text', 'talon' ),
	            'section' 	=> 'talon_slider',
	            'type' 		=> 'text',
	            'priority' 	=> 10
	        )
    ...
    $wp_customize->add_setting(
        'primary_color_hover',
        array(
            'default'           => $defaults['primary_color_hover'],
            'sanitize_callback' => 'sanitize_hex_color',
        )
    );
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'primary_color_hover',
            array(
                'label' 	=> __('Primary color:hover', 'talon'),
                'section' 	=> 'colors',
                'priority' 	=> 11
            )
        )
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'secondary_color',
            array(
                'label' 	=> __('Secondary color', 'talon'),
                'section' 	=> 'colors',
                'priority' 	=> 11
            )
        )
    ...
    $wp_customize->add_setting(
        ...
        array(
            'default'           => $defaults['secondary_color_hover'],
            'sanitize_callback' => 'sanitize_hex_color',
        )
    );
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'secondary_color_hover',
            array(
                'label' 	=> __('Secondary color:hover', 'talon'),
                'section' 	=> 'colors',
                'priority' 	=> 11
            )
        )
